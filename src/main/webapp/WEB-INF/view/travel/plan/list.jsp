	    	...
	    	<div class="row justify-content-center box_search mb40">
		            <div class="col-12 col-sm-3 col-lg-2">
		            	<select name="searchKey">
		            		<option value="subject" ${searchKey == 'subject' ? "selected='selected'" : ""}>제목 검색</option>
		            		<option value="location" ${searchKey == 'userCount' ? "selected='selected'" : ""}>지역검색</option>
		            		<option value="userId" ${searchKey == 'content' ? "selected='selected'" : ""}>작성자 검색</option>
		            		<option value="startDay" ${searchKey == 'startDate' ? "selected='selected'" : ""}>시작일</option>
		            		<option value="dayCount" ${searchKey == 'endDate' ? "selected='selected'" : ""}>여행일수</option>
		            	</select>
		            </div>
            ...
            <div class="col-12">
                ...
                <c:if test="${empty list}">
                	<div class="t_center mt40 mb40">
                		<span class="f14 exbold">등록된 일정이 없습니다.</span>
                	</div>
                </c:if>          
