...
<section class="welcome-area">
	...
	<div class="projects-slides owl-carousel">
	    ...
	    <div class="single-project-slide active bg-img" style="background-image: url(<%=cp%>/resources/images/bg-img/5.jpg);">
	        <!-- Project Text -->
	    ...
	    <!-- Single Project Slide -->
	    <div class="single-project-slide bg-img" style="background-image: url(<%=cp%>/resources/images/bg-img/6.jpg);">
	        <!-- Project Text -->
	        <div class="project-content">
	            <div class="text">
	                <h6>Entertaiment</h6>
	    ...
	    <!-- Single Project Slide -->
	    <div class="single-project-slide bg-img" style="background-image: url(<%=cp%>/resources/images/bg-img/7.jpg);">
	        <!-- Project Text -->
	        <div class="project-content">
	            <div class="text">
	                <h6>Entertaiment</h6>
	    ...
	    <!-- Single Project Slide -->
	    <div class="single-project-slide bg-img" style="background-image: url(<%=cp%>/resources/images/bg-img/8.jpg);">
	        <!-- Project Text -->
	        <div class="project-content">
	            <div class="text">
	                <h6>Entertaiment</h6>
	    ...
	    <!-- Single Project Slide -->
	    <div class="single-project-slide bg-img" style="background-image: url(<%=cp%>/resources/images/bg-img/9.jpg);">
	        <!-- Project Text -->
	        <div class="project-content">
	            <div class="text">
	                <h6>Entertaiment</h6>
