...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		if(total_page > numPerBlock && currentPageSetup > 0) {
			...
			sb.append("<a href='"+list_url+"page=1' class=\"page-link\"><i class=\"fa fa-angle-double-left\"></a>");
			sb.append("</li>");
			sb.append("<li class='page-item'>");
			sb.append("<a href='"+list_url+"page="+n+"' class=\"page-link\"><i class=\"fa fa-angle-left\"></i></a>");
			sb.append("</li>");
		}
		...
		if(total_page-currentPageSetup>numPerBlock) {
			...
			sb.append("<li class='page-item'>");
			sb.append("<a href='"+list_url+"page=1' class=\"page-link\"><i class=\"fa fa-angle-right\"></a>");
			sb.append("</li>");
			sb.append("<li class='page-item'>");
			sb.append("<a href='"+list_url+"page="+n+"' class=\"page-link\"><i class=\"fa fa-angle-double-right\"></i></a>");
			sb.append("</li>");
		}
		sb.append("</ul>");
    ...
    public String pagingMethod(int current_page, int total_page, String methodName) {
        ...
        if ((total_page > numPerBlock) && (currentPageSetUp > 0)) {
			...
			sb.append("<li><a onclick='"+methodName+"(1);'><i class='fa fa-angle-double-left'></i></a></li>");
			sb.append("<li><a '"+methodName+"("+n+");'><i class='fa fa-angle-left'></i></a></li>");
        }
        ...
        if (total_page - currentPageSetUp > numPerBlock) {
			...
			sb.append("<li><a onclick='"+methodName+"("+n+");'><i class='fa fa-angle-right'></i></a></li>");
			sb.append("<li><a onclick='"+methodName+"("+total_page+");'><i class='fa fa-angle-double-right'></i></a></li>");
        }
		sb.append("</ul>");
